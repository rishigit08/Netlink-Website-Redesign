...
export const industries: IndustrySolution[] = [
  ...
  },
  {
    id: "banking",
    name: "Banking",
    tagline: "Intelligent banking solutions that modernize core operations, automate compliance, and deliver seamless customer experiences across every channel.",
    solutions: [
      "Omni-Channel Customer Onboarding Automation Tool",
      "Digital Core Banking Enablement Suite",
      "Loan Origination Automation Platform",
      "Omnichannel Banking Experience Platform",
      "Customer Care Workflow Automation Suite",
      "Integrated CRM & Service Workflow Automation Suite",
      "Customer Engagement & Self-Service Mobile Platform",
      "Financial Crime & Transaction Monitoring Automation Platform",
      "Real-Time Financial Intelligence & Analytics Tool",
      "Employee Access Lifecycle Management Platform",
      "Digital Identity & Access Management Automation Suite",
    ],
  },
];
